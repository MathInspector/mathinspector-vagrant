...
sudo apt install -y mesa-common-dev libgl1-mesa-dev libglu1-mesa-dev >/dev/null 2>&1
sudo apt install -y mesa-utils libgl1-mesa-glx >/dev/null 2>&1
sudo apt install -y mesa-libGLw-dev.x86_64 >/dev/null 2>&1
...
pip3 install cloudpickle numpy pillow pygame pyglm PyOpenGL PyOpenGL_accelerate setuptools scikit-image scipy ttkthemes watchdog  >/dev/null 2>&1
